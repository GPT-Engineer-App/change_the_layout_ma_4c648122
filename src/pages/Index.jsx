            ...
            <Box bg="white" p={6} borderRadius="md" boxShadow="md">
              ...
              <VStack align="start" spacing={2}>
                ...
                <Text fontSize="md">
                  Breakdown:
                  <br />
                  Start Fare: £{startFare.toFixed(2)}
                  <br />
                  Distance Fare: £{distanceFare.toFixed(2)}
                  <br />
                  Additional Passengers: £{additionalPassengersFare.toFixed(2)}
                  <br />
                  Children: £{childrenFare.toFixed(2)}
                  <br />
                  Luggage: £{luggageFare.toFixed(2)}
                  <br />
                  Cycles: £{cyclesFare.toFixed(2)}
                  <br />
                  Waiting Time: £{waitingTimeFare.toFixed(2)}
                </Text>
              </VStack>
            </Box>
          </GridItem>
